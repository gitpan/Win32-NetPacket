...
qw( GetAdapterNames GetNetInfo GetVersion
_PacketGetAdapterNames _PacketGetNetInfo _PacketOpenAdapter
_PacketCloseAdapter _PacketAllocatePacket _GetBytesReceived
_PacketFreePacket _PacketInitPacket _PacketReceivePacket
_PacketSetHwFilter _PacketSetBuff _PacketGetStats
_PacketSetReadTimeout _PacketResetAdapter _PacketGetRequest _PacketSetBpf
_PacketSetNumWrites _PacketSendPacket _PacketSetMode
)],

'ndis' => [
qw( NDIS_802_3_MAC_OPTION_PRIORITY NDIS_PACKET_TYPE_DIRECTED NDIS_PACKET_TYPE_MULTICAST
NDIS_PACKET_TYPE_ALL_MULTICAST NDIS_PACKET_TYPE_BROADCAST NDIS_PACKET_TYPE_SOURCE_ROUTING
NDIS_PACKET_TYPE_PROMISCUOUS NDIS_PACKET_TYPE_SMT NDIS_PACKET_TYPE_ALL_LOCAL
NDIS_PACKET_TYPE_MAC_FRAME NDIS_PACKET_TYPE_FUNCTIONAL NDIS_PACKET_TYPE_ALL_FUNCTIONAL
...
NDIS_RING_AUTO_REMOVAL_ERROR NDIS_RING_REMOVE_RECEIVED NDIS_RING_COUNTER_OVERFLOW
NDIS_RING_SINGLE_STATION NDIS_RING_RING_RECOVERY NDIS_PROT_OPTION_ESTIMATED_LENGTH
NDIS_PROT_OPTION_NO_LOOPBACK NDIS_PROT_OPTION_NO_RSVD_ON_RCVPKT NDIS_MAC_OPTION_COPY_LOOKAHEAD_DATA
NDIS_MAC_OPTION_RECEIVE_SERIALIZED NDIS_MAC_OPTION_TRANSFERS_NOT_PEND NDIS_MAC_OPTION_NO_LOOPBACK
NDIS_MAC_OPTION_FULL_DUPLEX NDIS_MAC_OPTION_EOTX_INDICATION NDIS_MAC_OPTION_RESERVED
NDIS_CO_MAC_OPTION_DYNAMIC_LINK_SPEED
)],

'oid' => [
qw( OID_GEN_SUPPORTED_LIST OID_GEN_HARDWARE_STATUS OID_GEN_MEDIA_SUPPORTED
...
OID_GEN_VENDOR_DRIVER_VERSION OID_GEN_XMIT_OK OID_GEN_RCV_OK
OID_GEN_XMIT_ERROR OID_GEN_RCV_ERROR OID_GEN_RCV_NO_BUFFER
OID_GEN_DIRECTED_BYTES_XMIT OID_GEN_DIRECTED_FRAMES_XMIT OID_GEN_MULTICAST_BYTES_XMIT
OID_GEN_MULTICAST_FRAMES_XMIT OID_GEN_BROADCAST_BYTES_XMIT OID_GEN_BROADCAST_FRAMES_XMIT
OID_GEN_DIRECTED_BYTES_RCV OID_GEN_DIRECTED_FRAMES_RCV OID_GEN_MULTICAST_BYTES_RCV
OID_GEN_MULTICAST_FRAMES_RCV OID_GEN_BROADCAST_BYTES_RCV OID_GEN_BROADCAST_FRAMES_RCV
OID_GEN_RCV_CRC_ERROR OID_GEN_TRANSMIT_QUEUE_LENGTH OID_GEN_GET_TIME_CAPS
OID_GEN_GET_NETCARD_TIME OID_GEN_CO_SUPPORTED_LIST OID_GEN_CO_HARDWARE_STATUS
OID_GEN_CO_MEDIA_SUPPORTED OID_GEN_CO_MEDIA_IN_USE OID_GEN_CO_LINK_SPEED
OID_GEN_CO_VENDOR_ID OID_GEN_CO_VENDOR_DESCRIPTION OID_GEN_CO_DRIVER_VERSION
OID_GEN_CO_PROTOCOL_OPTIONS OID_GEN_CO_MAC_OPTIONS OID_GEN_CO_MEDIA_CONNECT_STATUS
OID_GEN_CO_VENDOR_DRIVER_VERSION OID_GEN_CO_MINIMUM_LINK_SPEED OID_GEN_CO_GET_TIME_CAPS
OID_GEN_CO_GET_NETCARD_TIME OID_GEN_CO_XMIT_PDUS_OK OID_GEN_CO_RCV_PDUS_OK
OID_GEN_CO_XMIT_PDUS_ERROR OID_GEN_CO_RCV_PDUS_ERROR OID_GEN_CO_RCV_PDUS_NO_BUFFER
OID_GEN_CO_RCV_CRC_ERROR OID_GEN_CO_TRANSMIT_QUEUE_LENGTH OID_GEN_CO_BYTES_XMIT
OID_GEN_CO_BYTES_RCV OID_GEN_CO_BYTES_XMIT_OUTSTANDING OID_GEN_CO_NETCARD_LOAD
OID_CO_ADD_PVC OID_CO_DELETE_PVC OID_CO_GET_CALL_INFORMATION
OID_CO_ADD_ADDRESS OID_CO_DELETE_ADDRESS OID_CO_GET_ADDRESSES
OID_CO_ADDRESS_CHANGE OID_CO_SIGNALING_ENABLED OID_CO_SIGNALING_DISABLED
OID_802_3_PERMANENT_ADDRESS OID_802_3_CURRENT_ADDRESS OID_802_3_MULTICAST_LIST
OID_802_3_MAXIMUM_LIST_SIZE OID_802_3_MAC_OPTIONS OID_802_3_RCV_ERROR_ALIGNMENT
...
OID_802_5_PERMANENT_ADDRESS OID_802_5_CURRENT_ADDRESS OID_802_5_CURRENT_FUNCTIONAL
OID_802_5_CURRENT_GROUP OID_802_5_LAST_OPEN_STATUS OID_802_5_CURRENT_RING_STATUS
OID_802_5_CURRENT_RING_STATE OID_802_5_LINE_ERRORS OID_802_5_LOST_FRAMES
OID_802_5_BURST_ERRORS OID_802_5_AC_ERRORS OID_802_5_ABORT_DELIMETERS
OID_802_5_FRAME_COPIED_ERRORS OID_802_5_FREQUENCY_ERRORS OID_802_5_TOKEN_ERRORS
OID_802_5_INTERNAL_ERRORS OID_FDDI_LONG_PERMANENT_ADDR OID_FDDI_LONG_CURRENT_ADDR
OID_FDDI_LONG_MULTICAST_LIST OID_FDDI_LONG_MAX_LIST_SIZE OID_FDDI_SHORT_PERMANENT_ADDR
OID_FDDI_SHORT_CURRENT_ADDR OID_FDDI_SHORT_MULTICAST_LIST OID_FDDI_SHORT_MAX_LIST_SIZE
OID_FDDI_ATTACHMENT_TYPE OID_FDDI_UPSTREAM_NODE_LONG OID_FDDI_DOWNSTREAM_NODE_LONG
OID_FDDI_FRAME_ERRORS OID_FDDI_FRAMES_LOST OID_FDDI_RING_MGT_STATE
OID_FDDI_LCT_FAILURES OID_FDDI_LEM_REJECTS OID_FDDI_LCONNECTION_STATE
OID_FDDI_SMT_STATION_ID OID_FDDI_SMT_OP_VERSION_ID OID_FDDI_SMT_HI_VERSION_ID
OID_FDDI_SMT_LO_VERSION_ID OID_FDDI_SMT_MANUFACTURER_DATA OID_FDDI_SMT_USER_DATA
OID_FDDI_SMT_MIB_VERSION_ID OID_FDDI_SMT_MAC_CT OID_FDDI_SMT_NON_MASTER_CT
OID_FDDI_SMT_MASTER_CT OID_FDDI_SMT_AVAILABLE_PATHS OID_FDDI_SMT_CONFIG_CAPABILITIES
OID_FDDI_SMT_CONFIG_POLICY OID_FDDI_SMT_CONNECTION_POLICY OID_FDDI_SMT_T_NOTIFY
OID_FDDI_SMT_STAT_RPT_POLICY OID_FDDI_SMT_TRACE_MAX_EXPIRATION OID_FDDI_SMT_PORT_INDEXES
OID_FDDI_SMT_MAC_INDEXES OID_FDDI_SMT_BYPASS_PRESENT OID_FDDI_SMT_ECM_STATE
OID_FDDI_SMT_CF_STATE OID_FDDI_SMT_HOLD_STATE OID_FDDI_SMT_REMOTE_DISCONNECT_FLAG
OID_FDDI_SMT_STATION_STATUS OID_FDDI_SMT_PEER_WRAP_FLAG OID_FDDI_SMT_MSG_TIME_STAMP
OID_FDDI_SMT_TRANSITION_TIME_STAMP OID_FDDI_SMT_SET_COUNT OID_FDDI_SMT_LAST_SET_STATION_ID
OID_FDDI_MAC_FRAME_STATUS_FUNCTIONS OID_FDDI_MAC_BRIDGE_FUNCTIONS OID_FDDI_MAC_T_MAX_CAPABILITY
OID_FDDI_MAC_TVX_CAPABILITY OID_FDDI_MAC_AVAILABLE_PATHS OID_FDDI_MAC_CURRENT_PATH
OID_FDDI_MAC_UPSTREAM_NBR OID_FDDI_MAC_DOWNSTREAM_NBR OID_FDDI_MAC_OLD_UPSTREAM_NBR
OID_FDDI_MAC_OLD_DOWNSTREAM_NBR OID_FDDI_MAC_DUP_ADDRESS_TEST OID_FDDI_MAC_REQUESTED_PATHS
OID_FDDI_MAC_DOWNSTREAM_PORT_TYPE OID_FDDI_MAC_INDEX OID_FDDI_MAC_SMT_ADDRESS
OID_FDDI_MAC_LONG_GRP_ADDRESS OID_FDDI_MAC_SHORT_GRP_ADDRESS OID_FDDI_MAC_T_REQ
OID_FDDI_MAC_T_NEG OID_FDDI_MAC_T_MAX OID_FDDI_MAC_TVX_VALUE
OID_FDDI_MAC_T_PRI0 OID_FDDI_MAC_T_PRI1 OID_FDDI_MAC_T_PRI2
OID_FDDI_MAC_T_PRI3 OID_FDDI_MAC_T_PRI4 OID_FDDI_MAC_T_PRI5
OID_FDDI_MAC_T_PRI6 OID_FDDI_MAC_FRAME_CT OID_FDDI_MAC_COPIED_CT
OID_FDDI_MAC_TRANSMIT_CT OID_FDDI_MAC_TOKEN_CT OID_FDDI_MAC_ERROR_CT
OID_FDDI_MAC_LOST_CT OID_FDDI_MAC_TVX_EXPIRED_CT OID_FDDI_MAC_NOT_COPIED_CT
OID_FDDI_MAC_LATE_CT OID_FDDI_MAC_RING_OP_CT OID_FDDI_MAC_FRAME_ERROR_THRESHOLD
OID_FDDI_MAC_FRAME_ERROR_RATIO OID_FDDI_MAC_NOT_COPIED_THRESHOLD OID_FDDI_MAC_NOT_COPIED_RATIO
OID_FDDI_MAC_RMT_STATE OID_FDDI_MAC_DA_FLAG OID_FDDI_MAC_UNDA_FLAG
OID_FDDI_MAC_FRAME_ERROR_FLAG OID_FDDI_MAC_NOT_COPIED_FLAG OID_FDDI_MAC_MA_UNITDATA_AVAILABLE
OID_FDDI_MAC_HARDWARE_PRESENT OID_FDDI_MAC_MA_UNITDATA_ENABLE OID_FDDI_PATH_INDEX
OID_FDDI_PATH_RING_LATENCY OID_FDDI_PATH_TRACE_STATUS OID_FDDI_PATH_SBA_PAYLOAD
OID_FDDI_PATH_SBA_OVERHEAD OID_FDDI_PATH_CONFIGURATION OID_FDDI_PATH_T_R_MODE
OID_FDDI_PATH_SBA_AVAILABLE OID_FDDI_PATH_TVX_LOWER_BOUND OID_FDDI_PATH_T_MAX_LOWER_BOUND
OID_FDDI_PATH_MAX_T_REQ OID_FDDI_PORT_MY_TYPE OID_FDDI_PORT_NEIGHBOR_TYPE
OID_FDDI_PORT_CONNECTION_POLICIES OID_FDDI_PORT_MAC_INDICATED OID_FDDI_PORT_CURRENT_PATH
OID_FDDI_PORT_REQUESTED_PATHS OID_FDDI_PORT_MAC_PLACEMENT OID_FDDI_PORT_AVAILABLE_PATHS
OID_FDDI_PORT_MAC_LOOP_TIME OID_FDDI_PORT_PMD_CLASS OID_FDDI_PORT_CONNECTION_CAPABILITIES
OID_FDDI_PORT_INDEX OID_FDDI_PORT_MAINT_LS OID_FDDI_PORT_BS_FLAG
OID_FDDI_PORT_PC_LS OID_FDDI_PORT_EB_ERROR_CT OID_FDDI_PORT_LCT_FAIL_CT
OID_FDDI_PORT_LER_ESTIMATE OID_FDDI_PORT_LEM_REJECT_CT OID_FDDI_PORT_LEM_CT
OID_FDDI_PORT_LER_CUTOFF OID_FDDI_PORT_LER_ALARM OID_FDDI_PORT_CONNNECT_STATE
OID_FDDI_PORT_PCM_STATE OID_FDDI_PORT_PC_WITHHOLD OID_FDDI_PORT_LER_FLAG
OID_FDDI_PORT_HARDWARE_PRESENT OID_FDDI_SMT_STATION_ACTION OID_FDDI_PORT_ACTION
OID_FDDI_IF_DESCR OID_FDDI_IF_TYPE OID_FDDI_IF_MTU
...
OID_FDDI_IF_IN_UCAST_PKTS OID_FDDI_IF_IN_NUCAST_PKTS OID_FDDI_IF_IN_DISCARDS
OID_FDDI_IF_IN_ERRORS OID_FDDI_IF_IN_UNKNOWN_PROTOS OID_FDDI_IF_OUT_OCTETS
OID_FDDI_IF_OUT_UCAST_PKTS OID_FDDI_IF_OUT_NUCAST_PKTS OID_FDDI_IF_OUT_DISCARDS
OID_FDDI_IF_OUT_ERRORS OID_FDDI_IF_OUT_QLEN OID_FDDI_IF_SPECIFIC
OID_WAN_PERMANENT_ADDRESS OID_WAN_CURRENT_ADDRESS OID_WAN_QUALITY_OF_SERVICE
OID_WAN_PROTOCOL_TYPE OID_WAN_MEDIUM_SUBTYPE OID_WAN_HEADER_FORMAT
OID_WAN_GET_INFO OID_WAN_SET_LINK_INFO OID_WAN_GET_LINK_INFO
OID_WAN_LINE_COUNT OID_WAN_GET_BRIDGE_INFO OID_WAN_SET_BRIDGE_INFO
OID_WAN_GET_COMP_INFO OID_WAN_SET_COMP_INFO OID_WAN_GET_STATS_INFO
OID_LTALK_CURRENT_NODE_ID OID_LTALK_IN_BROADCASTS OID_LTALK_IN_LENGTH_ERRORS
OID_LTALK_OUT_NO_HANDLERS OID_LTALK_COLLISIONS OID_LTALK_DEFERS
OID_LTALK_NO_DATA_ERRORS OID_LTALK_RANDOM_CTS_ERRORS OID_LTALK_FCS_ERRORS
OID_ARCNET_PERMANENT_ADDRESS OID_ARCNET_CURRENT_ADDRESS OID_ARCNET_RECONFIGURATIONS
OID_TAPI_ACCEPT OID_TAPI_ANSWER OID_TAPI_CLOSE
OID_TAPI_CLOSE_CALL OID_TAPI_CONDITIONAL_MEDIA_DETECTION OID_TAPI_CONFIG_DIALOG
OID_TAPI_DEV_SPECIFIC OID_TAPI_DIAL OID_TAPI_DROP
OID_TAPI_GET_ADDRESS_CAPS OID_TAPI_GET_ADDRESS_ID OID_TAPI_GET_ADDRESS_STATUS
OID_TAPI_GET_CALL_ADDRESS_ID OID_TAPI_GET_CALL_INFO OID_TAPI_GET_CALL_STATUS
OID_TAPI_GET_DEV_CAPS OID_TAPI_GET_DEV_CONFIG OID_TAPI_GET_EXTENSION_ID
OID_TAPI_GET_ID OID_TAPI_GET_LINE_DEV_STATUS OID_TAPI_MAKE_CALL
OID_TAPI_NEGOTIATE_EXT_VERSION OID_TAPI_OPEN OID_TAPI_PROVIDER_INITIALIZE
OID_TAPI_PROVIDER_SHUTDOWN OID_TAPI_SECURE_CALL OID_TAPI_SELECT_EXT_VERSION
OID_TAPI_SEND_USER_USER_INFO OID_TAPI_SET_APP_SPECIFIC OID_TAPI_SET_CALL_PARAMS
OID_TAPI_SET_DEFAULT_MEDIA_DETECTION OID_TAPI_SET_DEV_CONFIG OID_TAPI_SET_MEDIA_MODE
OID_TAPI_SET_STATUS_MESSAGES OID_ATM_SUPPORTED_VC_RATES OID_ATM_SUPPORTED_SERVICE_CATEGORY
OID_ATM_SUPPORTED_AAL_TYPES OID_ATM_HW_CURRENT_ADDRESS OID_ATM_MAX_ACTIVE_VCS
OID_ATM_MAX_ACTIVE_VCI_BITS OID_ATM_MAX_ACTIVE_VPI_BITS OID_ATM_MAX_AAL0_PACKET_SIZE
OID_ATM_MAX_AAL1_PACKET_SIZE OID_ATM_MAX_AAL34_PACKET_SIZE OID_ATM_MAX_AAL5_PACKET_SIZE
OID_ATM_SIGNALING_VPIVCI OID_ATM_ASSIGNED_VPI OID_ATM_ACQUIRE_ACCESS_NET_RESOURCES
OID_ATM_RELEASE_ACCESS_NET_RESOURCES OID_ATM_ILMI_VPIVCI OID_ATM_DIGITAL_BROADCAST_VPIVCI
OID_ATM_GET_NEAREST_FLOW OID_ATM_ALIGNMENT_REQUIRED OID_ATM_RCV_CELLS_OK
OID_ATM_XMIT_CELLS_OK OID_ATM_RCV_CELLS_DROPPED OID_ATM_RCV_INVALID_VPI_VCI
OID_ATM_CELLS_HEC_ERROR OID_ATM_RCV_REASSEMBLY_ERROR OID_WW_GEN_NETWORK_TYPES_SUPPORTED
OID_WW_GEN_NETWORK_TYPE_IN_USE OID_WW_GEN_HEADER_FORMATS_SUPPORTED OID_WW_GEN_HEADER_FORMAT_IN_USE
OID_WW_GEN_INDICATION_REQUEST OID_WW_GEN_DEVICE_INFO OID_WW_GEN_OPERATION_MODE
OID_WW_GEN_LOCK_STATUS OID_WW_GEN_DISABLE_TRANSMITTER OID_WW_GEN_NETWORK_ID
OID_WW_GEN_PERMANENT_ADDRESS OID_WW_GEN_CURRENT_ADDRESS OID_WW_GEN_SUSPEND_DRIVER
OID_WW_GEN_BASESTATION_ID OID_WW_GEN_CHANNEL_ID OID_WW_GEN_ENCRYPTION_SUPPORTED
OID_WW_GEN_ENCRYPTION_IN_USE OID_WW_GEN_ENCRYPTION_STATE OID_WW_GEN_CHANNEL_QUALITY
OID_WW_GEN_REGISTRATION_STATUS OID_WW_GEN_RADIO_LINK_SPEED OID_WW_GEN_LATENCY
OID_WW_GEN_BATTERY_LEVEL OID_WW_GEN_EXTERNAL_POWER OID_WW_MBX_SUBADDR
OID_WW_MBX_FLEXLIST OID_WW_MBX_GROUPLIST OID_WW_MBX_TRAFFIC_AREA
OID_WW_MBX_LIVE_DIE OID_WW_MBX_TEMP_DEFAULTLIST OID_WW_PIN_LOC_AUTHORIZE
OID_WW_PIN_LAST_LOCATION OID_WW_PIN_LOC_FIX OID_WW_CDPD_SPNI
OID_WW_CDPD_WASI OID_WW_CDPD_AREA_COLOR OID_WW_CDPD_TX_POWER_LEVEL
OID_WW_CDPD_EID OID_WW_CDPD_HEADER_COMPRESSION OID_WW_CDPD_DATA_COMPRESSION
OID_WW_CDPD_CHANNEL_SELECT OID_WW_CDPD_CHANNEL_STATE OID_WW_CDPD_NEI
OID_WW_CDPD_NEI_STATE OID_WW_CDPD_SERVICE_PROVIDER_IDENTIFIER OID_WW_CDPD_SLEEP_MODE
OID_WW_CDPD_CIRCUIT_SWITCHED OID_WW_CDPD_TEI OID_WW_CDPD_RSSI
OID_WW_ARD_SNDCP OID_WW_ARD_TMLY_MSG OID_WW_ARD_DATAGRAM
OID_WW_TAC_COMPRESSION OID_WW_TAC_SET_CONFIG OID_WW_TAC_GET_STATUS
OID_WW_TAC_USER_HEADER OID_WW_MET_FUNCTION OID_IRDA_RECEIVING
OID_IRDA_TURNAROUND_TIME OID_IRDA_SUPPORTED_SPEEDS OID_IRDA_LINK_SPEED
OID_IRDA_MEDIA_BUSY OID_IRDA_EXTRA_RCV_BOFS OID_IRDA_RATE_SNIFF
OID_IRDA_UNICAST_LIST OID_IRDA_MAX_UNICAST_LIST_SIZE OID_IRDA_MAX_RECEIVE_WINDOW_SIZE
OID_IRDA_MAX_SEND_WINDOW_SIZE
)],

'mode' =>[ 'MODE_CAPT', 'MODE_STAT' ],

);

our @EXPORT_OK = ( 'GetAdapterNames', 'GetNetInfo', 'GetVersion',
                   'MODE_CAPT', 'MODE_STAT',
                   @{ $EXPORT_TAGS{'hack'} },
                   @{ $EXPORT_TAGS{'ndis'} },
                   @{ $EXPORT_TAGS{'oid'} },
...
sub GetAdapterNames {
  ...
  my $buff = ' ' x 4096;
  _PacketGetAdapterNames($buff);
  my $n;
  if ( Win32::IsWinNT() ) {         # for WinNT/2000/XP
    ($n) = $buff =~ /(.*)\x00\x00\x00\x00/;
    $n =~ s/(.)\x00/$1/gis;   # UNICODE to ANSI (...rough ;-)
  }
  else {                            # for Win95/98/Me
    ($n) = $buff =~ /(.*?)\x00\x00/;
  }
  my @n = split /\x00/, $n;
...
sub GetNetInfo {
  ...
  return unless $ip;
  $ip = join '.', reverse unpack "C4", pack 'L', $ip;
  $mask = join '.', reverse unpack "C4", pack 'L', $mask;
  return $ip, $mask;
}
...
sub new {
  ...
  # ------------ adapter
  $self->{_name} = exists $arg{adapter_name} ? $arg{adapter_name} : GetAdapterNames();
  ...
  if (exists $arg{driver_buffer_size}) {
    if ($arg{driver_buffer_size} =~ /^\d+$/) {
      ...
      _fatal_error($self, "driver_buffer_size must be a positive integer, not \"$arg{driver_buffer_size}\"");
    }
  }
  _PacketSetBuff($self->{_adapter}, $dbs) or
      _fatal_error($self, "Unable to set the driver buffer size");
  ...
  if (exists $arg{read_timeout}) {
    if ($arg{read_timeout} =~ /^[+-]?\d+$/) {
      ...
      _fatal_error($self, "read_timeout must be an integer, not \"$arg{read_timeout}\"");
    }
  }
  _PacketSetReadTimeout($self->{_adapter}, $rt) or
      _fatal_error($self, "Unable to set read timeout");

  # ------------ min to copy
  if (exists $arg{min_to_copy}) {
    if ($arg{min_to_copy} =~ /^\d+$/) {
      _PacketSetMinToCopy($self->{_adapter}, $arg{min_to_copy}) or
          _fatal_error($self, "Unable to set the min_to_copy");
    }
    else {
      _fatal_error($self, "min_to_copy must be a positive integer, not \"$arg{min_to_copy}\"");
    }
  }

  # ------------ mode
  if (exists $arg{mode}) {
    _PacketSetMode($self->{_adapter}, $arg{'mode'}) or
        _fatal_error($self, "Unable to set the mode");
  }
...
sub GetInfo {
  my $self = shift;
  my $description ='';
  my $Oid = pack "LLC256", 0x0001010D, 256;
  $description = (unpack "LLA*", $Oid)[2] if _PacketGetRequest($self->{_adapter}, $Oid);
  my ($t, $speed) = _PacketGetNetType($self->{_adapter});
  my ($ip, $mask) = GetNetInfo( $self->{_name} );
  return $self->{_name}, $description, $type[$t], $speed, $ip, $mask;
}
...
=head1 SYNOPSIS
  ...
  my ($name, $description, $type, $speed, $ip, $mask) = $nic->GetInfo();
  print "Name: $name\n$description\nType: $type (speed: $speed bits/s)\n";
  print "IP: $ip Net mask: $mask\n";
...
for Windows. To use this module, it is necessary to install WinPcap 3.0
...
=item ($name, $description, $type, $speed, $ip, $mask) = $nic-E<gt>GetInfo();

Returns, in a list, the name, the description string, the type, the speed
in bits per second, the IP address and the net mask of C<$nic>
...
Example: OID_GEN_SUPPORTED_LIST is a mandatory OID which specifies an array
...
The following script prints the list of all OIDs supported by the default C<$nic>.
    ...
    foreach my $tag (@{$Win32::NetPacket::EXPORT_TAGS{'oid'}}) {
      $OIDTAG{eval "$tag"} = $tag unless $tag =~ /^OID_GEN_CO_/;
    }
...
=item @list = GetAdapterNames();

=item $card = GetAdapterNames();
...
WinPCap Home Page: http://winpcap.polito.it/default.htm

WinPCap download page (download and install the 3.0 version):
...
Microsoft DDK doc (NDIS OID):
  ...
  http://msdn.microsoft.com/library/en-us/network/hh/network/21oidovw_9sdu.asp
...
Licence: http://winpcap.polito.it/misc/copyright.htm
